...
# this trader agent should run after analyst agent, analyst agent will collect all the data, do analysis and pass it to the trader agent. It does not uses any specilised tool.