...
# Creates an embedding model and specifies which hardware device to use.
# 'cuda' for NVIDIA GPU, 'cpu' for CPU
# Since you did NOT specify model_name, LangChain uses its default embedding model and runs it on CPU.
# embeddings = HuggingFaceEmbeddings(model_name = "all-MiniLM-L6-v2")
# Creates embeddings using a specific pretrained model.
