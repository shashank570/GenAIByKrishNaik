...
# Finds ONE document
# Updates it -> set document["last_interacted"] = ts
# Returns document
# Find conversation whose ID is abc123
...
# .find() -> Fetches documents from MongoDB.
# first argument -> {} -> Empty filter -> Fetch ALL documents -> Equivalent to -> SELECT * FROM conversations
# {"title": 1} -> this is called projection -> Only return the title field -> MongoDB automatically includes _id
# {
#     "_id": "1",
#     "title": "Python Help"
# }
